...
public class Environment extends SimStateSweep {
	...
	public int _walkaways = 0;//initial number of walkaways
	public int _walkawayD = 0; //initial number of walkawayD
	public int _tftm = 0; //initial number of tit for tat mobile
	public int _tfts = 0;// initial number of tit for tat stationary
	public int _pavlovm = 0;// initial number of pavlov mobile
	public int _pavlovs = 0;// initial number of pavlov stationary
	public int _pavlovw = 0;// initial number of pavlov walkaway, a possible strategy that can be implemented
	...
	public boolean groups_or_patches = true; //Multiple agents can be in the same location (patch) or what we can also call a group
	public double averageAge = 100;//this is how long in steps on average an agent lives
	public double sdAge = 10; //this is the standard deviation in the variation lifespan of agents relative to averageAge
	public double mutationRate = 0.0;//mutation rate from one strategy to the next
	public double resoucesToReproduce = 100;//total resource required to reproduce an agent
	public double minResourcesStart = 0; //this and the next variable specifies a range of resources to start a simulation
	public double maxResourcesStart = 50; //this is the maximum amount of resource to start with
	public double carryingCapacity = 1000;//the maximum total number of agents in a population
	public int searchOpponent = 1; //search radius for an opponent if groups is false
	public double cooperate_cooperator = 3; //payoff for cooperation
	public double defect_defector = 0;//defector payoff
	public double cooperate_defector = -1;//suckers payoff
	public double defect_cooperator = 5; //temptation payoff
	public int reproductionRadius = 1;//the distance from parent to offspring at birth
	...
	public void setGroups_or_patches(boolean groups_or_patches) {
		this.groups_or_patches = groups_or_patches;
	}

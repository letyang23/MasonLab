...
public class Environment extends SimStateSweep {
    ...
    public double maxFrustration = 50;
    ...
    public void setDateSearchRadius(int dataSearchRadius) {
        this.dateSearchRadius = dataSearchRadius;
    }
    ...
    public void makeAgent() {
        ...
        for (int i = 0; i < males; i++) {
            ...
            double attractiveness = random.nextInt((int) maxAttractiveness) + 1;
            int dirx = random.nextInt(3) - 1; // Random direction -1, 0, or 1
            int diry = random.nextInt(3) - 1; // Random direction -1, 0, or 1
